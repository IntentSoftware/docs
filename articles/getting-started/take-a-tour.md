...
Here you can search and choose which application template you want and set key settings like the Application's name, directly location and [Solution](#solutions) name.
